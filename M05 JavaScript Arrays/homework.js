...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   let promedio = resultadosTest.reduce((A,B) => A + B, 0);
...
function tablaDelSeis() {
   ...
   // Tu código:
   let multiplicacionDelSeis = [];
   for (let i = 0; i < 11; i++){
      multiplicacionDelSeis.push(6 * i);
   }
   return multiplicacionDelSeis;
}
